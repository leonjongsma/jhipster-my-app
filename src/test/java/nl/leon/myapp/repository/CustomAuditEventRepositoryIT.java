...
import nl.leon.myapp.config.audit.AuditEventConverter;
import nl.leon.myapp.domain.PersistentAuditEvent;
...
import static nl.leon.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
